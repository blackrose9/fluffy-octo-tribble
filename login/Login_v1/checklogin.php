...
if(isset($_POST["checklogin"])){
	...
	if($checkuser=='1'){
	header("Location:../../fluffy-octo-tribble/add_business.php");
	exit();
	}
	else if($checkuser=='2'){
	
		header("Location:../../fluffy-octo-tribble/view_categories.php");
		exit();
		}
		}	
		...
		header("Location: ../../fluffy-octo-tribble/reg_users.php");
		exit();
